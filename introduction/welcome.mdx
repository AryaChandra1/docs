...
<Columns cols={3}>
  ...
  <Card title="Prompt Engineering" icon="brain" color="#80FFF9" href="/prompt-engineering/guide">
  ...
  <Card title="Tips & Tricks" icon="wand-magic-sparkles" color="#80FFF9" href="/tips-tricks/mastering-emergent">
    Improve your builds with insider tips, design ideas, and advanced tricks.
  </Card>
  <Card title="Custom Agents" icon="robot" color="#80FFF9" href="/agents/overview">
    Build and manage specialized AI agents for complex workflows.
  </Card>
  <Card title="Mastering Emergent" icon="sparkles" color="#80FFF9" href="/introduction/plans-and-credits">
